...
```text
take each rgb value and average them by using red1 red2 and so on.
```
...
```text
take input 2 colors. average the corresponding rgb values. red1 red2 blue1 blue2 green1 green2. 
```
